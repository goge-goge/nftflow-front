...
const contract = require("../artifacts/contracts/NFTflow.sol/NFTFLOW.json");
const contractAddress = "0xd7B982CEBCc41D2EDe2A019C2a980Ad885285FaB";
...
export const mintNFT = async (mintAmount) => {
  ...
  const transactionParameters = {
    ...
    value: parseInt(web3.utils.toWei("0.1", "ether") * mintAmount).toString(
      16
    ), // hex
    gasLimit: "0",
    data: nftContract.methods.mint2(mintAmount).encodeABI(), //make call to NFT smart contract
  };
